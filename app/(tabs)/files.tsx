...
import "../filemanager/src/FileApp.scss";
import FileManager from "../filemanager/src/FileManager/FileManager";

export default function Courses() {
    const fileUploadConfig = {
        url: process.env.EXPO_PUBLIC_VITE_API_BASE_URL + "/upload",
    };
    ...
    // Delete File/Folder
    const handleDelete = async (files: { _id: string }[]) => {
        setIsLoading(true);
        ...
        <div className="app">
            <div className="file-manager-container">
                <FileManager
                    ...
                    filePreviewPath={process.env.EXPO_PUBLIC_VITE_API_FILES_BASE_URL}
